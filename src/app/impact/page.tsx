      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="text-xs uppercase font-bold tracking-wider text-emerald-600 dark:text-emerald-400">
            Transparent Outcome Telemetry
          </span>
          <h1 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
            Verified Measurable Impact
          </h1>
          <p className="text-sm text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Honest accounting of delivered results. Every metric is backed by verified evidence or explicitly marked as awaiting third-party sign-off.
          </p>
        </div>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-2 pb-2 border-b border-slate-200 dark:border-slate-800">
            ...
            <h2 className="text-xl font-bold text-slate-900 dark:text-white">
              Fully Verified Production Metrics ({verifiedAchievements.length})
            </h2>
          </div>
        ...
        {/* Self-Reported / Verification Required Section */}
        <div className="space-y-6 pt-6">
          <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-2">
              <AlertCircle className="w-5 h-5 text-amber-500" />
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">
                Self-Reported / Verification Required ({pendingAchievements.length})
              </h2>
            </div>
            <span className="text-xs text-amber-600 dark:text-amber-400 font-semibold">
              Explicit Disclosure &bull; Awaiting Institutional Sign-Off
            </span>
          </div>
