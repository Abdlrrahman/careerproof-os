...
export default function ArabicChaosPage() {
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="text-xs uppercase font-bold tracking-wider text-amber-500">
            اختبارات المرونة والتعافي الآلي من الأعطال
          </span>
          <h1 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
            محاكي أعطال الأنظمة وهندسة المرونة
          </h1>
          <p className="text-sm text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            محاكاة تفاعلية فورية لأقسى سيناريوهات انهيار الأنظمة وحقن البيانات الخاطئة لإثبات قدرة المعمارية على التعافي الحتمي بدون أي فقدان للبيانات.
          </p>
        </div>
