      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <span className="text-xs uppercase font-bold tracking-wider text-blue-600 dark:text-cyan-400">
            دراسات الحالة والمعماريات البرمجية
          </span>
          <h1 className="text-3xl sm:text-5xl font-black text-slate-900 dark:text-white tracking-tight">
            الأنظمة الإنتاجية والمشاريع المنجزة
          </h1>
          <p className="text-sm text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            دراسات تفصيلية للقرارات المعمارية، وقيود الأنظمة، وسياسات الأمان والنتائج القابلة للقياس، مع تمييز واضح للمشاريع قيد التطوير.
          </p>
        </div>
        ...
        <div className="flex justify-center">
          <div className="inline-flex items-center bg-white dark:bg-slate-900 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm text-xs">
            ...
            >
              الأنظمة الإنتاجية ({productionProjects.length})
            </button>
            <button
            ...
            >
              مشاريع قيد التطوير ({conceptProjects.length})
            </button>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2 pb-2 border-b border-slate-200 dark:border-slate-800">
              ...
              <h2 className="text-xl font-bold text-slate-900 dark:text-white">
                الأنظمة الإنتاجية المكتملة والمنشورة
              </h2>
            </div>
          ...
          <div className="space-y-6 pt-6">
            <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-800">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-xl font-bold text-slate-900 dark:text-white">
                  المفاهيم والنماذج قيد التطوير والبحث
                </h2>
              </div>
              <span className="text-xs text-amber-600 dark:text-amber-400 font-semibold">
                مشاريع ونماذج قيد التطوير &bull; غير إنتاجية
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
